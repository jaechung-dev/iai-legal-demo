        ...
        <div className="relative space-y-10">
          <div>
            ...
            <h2 className="text-4xl font-bold text-white leading-tight">
              Free access to<br />NSW legal help
            </h2>
            <p className="text-zinc-400 mt-4 leading-relaxed text-sm max-w-sm">
              Create your free account to access plain English legal answers, case timelines, and AI-powered legal research.
            </p>
          </div>
        ...
        <div className="w-full max-w-sm space-y-6 py-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Free access to NSW legal research
            </p>
          </div>
              ...
              {passwordStrength && (
                <div className="space-y-1">
                  ...
                  <p className={`text-xs capitalize ${
                    ...
                    passwordStrength === 'fair' ? 'text-amber-500' : 'text-emerald-600'
